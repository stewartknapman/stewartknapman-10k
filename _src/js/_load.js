...
Load.prototype.img = function (id, alt, sizes, thumb) {
  var widths = (thumb)? [320,440,560,680,900] : [320,440,560,680,900,1080,1200,1500,1800,2100,3000];
  return '<img src="/i/'+id+widths[3]+'.jpg" srcset="'+this.imgSrcset(id, widths)+'" sizes="'+(sizes || '100vw')+'" alt="'+alt+'">';
};
